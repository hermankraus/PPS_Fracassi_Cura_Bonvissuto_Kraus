...
import { Box, Button, FormControl, FormLabel, Input, Select, Textarea, VStack, AlertDialog, AlertDialogBody, AlertDialogFooter, AlertDialogHeader, AlertDialogContent, AlertDialogOverlay } from '@chakra-ui/react';
          ...
          <Form onSubmit={handleSubmit}>
            <VStack spacing={4} align='stretch'>
              <FormControl>
                ...
                <ErrorMessage name="contractType" component="div" className="error" />
              </FormControl>
              ...
              <FormControl>
                ...
                <ErrorMessage name="workLocation" component="div" className="error" />
              </FormControl>
              ...
              <FormControl>
                ...
                <ErrorMessage name="cuitCompany" component="div" className="error" />
              </FormControl>

              <FormControl>
                <FormLabel>Fecha Límite</FormLabel>
                <Field type="date" as={Input} name="finallyDate" />
                <ErrorMessage name="finallyDate" component="div" className="error" />
              </FormControl>

              <FormControl>
                <FormLabel>Lugar de Trabajo</FormLabel>
                <Field type="text" as={Input} name="workPlace" />
                <ErrorMessage name="workPlace" component="div" className="error" />
              </FormControl>

              <FormControl>
                <FormLabel>Asignaturas Mínimas</FormLabel>
                <Field as={Input} type="number" name="minSubjects" />
                <ErrorMessage name="minSubjects" component="div" className="error" />
              </FormControl>

              <FormControl>
                <FormLabel>Fecha Estimada</FormLabel>
                <Field type="date" as={Input} name="estimatedDate" />
                <ErrorMessage name="estimatedDate" component="div" className="error" />
              </FormControl>
              ...
              <Button color='teal' type="submit" isLoading={isLoading} loadingText="Registrando...">
