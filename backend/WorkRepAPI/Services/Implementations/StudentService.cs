...
namespace WorkRepAPI.Services.Implementations
{
    public class StudentService: IStudentService
    {
        ...
        public getStudentsDTO GetStudentById(int Legajo)
        {
            var student = _studentRepository.GetStudentById(Legajo);
            if (student == null)
            {
                return null;
            }
        ...
        public bool UpdateStudentById(int id, updateStudentDTO studentDto)
        {
            return _studentRepository.UpdateStudentById(id, studentDto);
        }
